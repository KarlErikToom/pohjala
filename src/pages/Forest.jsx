    ...
    <div>
      <section id="forest">
        ...
        <div className="forest__text">
          <h1>
            The forest has a deep influence on Estonian culture and cuisine.
            This heritage is embodied in our Forest Series. <br /> <br /> In
            these editions, we twist rare botanicals, forest ingredients and
            Estonian folk-medicine with ancient methods into absolutely
            extraordinary beers.
          </h1>
        </div>
      </section>
              ...
              {beers.slice(0, 25).map((beer, index) => (
                <div key={beer.id} className="beer hidden">
                  ...
                  <div className="beer__info">
                    ...
                    {index % 6 === 4 && (
                      <span className="discontinued">sold out </span>
                    )}
