    ...
    <div>
      <section id="cellar">
        ...
        <div className="cellar__text">
          <h1>
            We love bold, dark, barrel-aged beers. <br /> <br /> In the Cellar
            Series, we unleash our passion for ever deeper layers of oily,
            velvety, liquid goodness. <br /> <br /> We use a variety of bourbon,
            cognac, sherry, and tequila barrels to age our unusual creations and
            create unique tastes by blending several distinctly different beers
            aged in complementary casks.
          </h1>
        </div>
      </section>
              ...
              {beers.slice(0, 25).map((beer, index) => (
                <div className="beer">
                  ...
                  <div className="beer__info">
                    ...
                    {index % 4 === 3 && (
                      <span className="discontinued">Seasonal </span>
                    )}
